...
<template>
  <div class="lg:container h-full mx-auto">
    <screen-root>
      <template #header>
        <div class="relative">
          <app-bar
            ...
            @back="router.back()"
          />
          <div class="w-full h-72 bg-fuchsia-500"></div>
        </div>
      </template>
        ...
        <div class="flex gap-2">
          ...
          <div>
            <div class="flex gap-1">
              <div class="text-semibold text-2xl">Estabelecimento</div>
              <CheckDecagramIcon class="text-fuchsia-700 mt-1" />
            </div>
